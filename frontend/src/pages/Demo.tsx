    ...
    <div>
      <section className="max-w-[1100px] mx-auto px-8 pt-24 pb-8">
        ...
        <p className="text-[16px] text-ink-2 leading-[1.6] max-w-[640px] mb-10">
          ...
          shows each tool's status as it completes. The 13-step reasoning pipeline runs server-side as 5 concurrent branches. Total wall time: <strong>~15 seconds (warm).</strong>
        </p>
      </section>
